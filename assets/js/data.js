/* =========================================================
   ...
   금액 단위: 원
   - price: 출고가
   - official[통신사]: 최고 요금제 기준 공시지원금 (요금제 월액에 비례 자동 계산)
   - support[통신사][가입유형]: '유지조건 요금제' 기준 총 지원금(공시+번쩍할인 합계)
     → 번쩍할인(매장 추가지원) = support − 유지조건 요금제 기준 공시지원금 (자동 계산)
   - plan: 가입 시 유지 요금제 안내
...
const PHONES = [
  {
    ...
    // 최고 요금제 기준 공시지원금 (요금제에 비례해 자동 계산됨)
    official: { SKT: 530000, KT: 550000, LGU: 580000 },
    support: {
  ...
  },
  {
    ...
    colors: ["블랙", "실버", "아이시 블루"],
    // 최고 요금제 기준 공시지원금 (요금제에 비례해 자동 계산됨)
    official: { SKT: 500000, KT: 520000, LGU: 540000 },
    support: {
  ...
  },
  {
    ...
    colors: ["블랙", "화이트", "민트"],
    // 최고 요금제 기준 공시지원금 (요금제에 비례해 자동 계산됨)
    official: { SKT: 530000, KT: 550000, LGU: 570000 },
    support: {
  ...
  },
  {
    ...
    // 최고 요금제 기준 공시지원금 (요금제에 비례해 자동 계산됨)
    official: { SKT: 550000, KT: 580000, LGU: 600000 },
    support: {
  ...
  },
  {
    ...
    // 최고 요금제 기준 공시지원금 (요금제에 비례해 자동 계산됨)
    official: { SKT: 500000, KT: 520000, LGU: 550000 },
    support: {
  ...
  },
  {
    ...
    // 최고 요금제 기준 공시지원금 (요금제에 비례해 자동 계산됨)
    official: { SKT: 245000, KT: 255000, LGU: 270000 },
    support: {
  ...
  },
  {
    ...
    colors: ["코스믹 오렌지", "딥 블루", "실버"],
    // 최고 요금제 기준 공시지원금 (요금제에 비례해 자동 계산됨)
    official: { SKT: 240000, KT: 250000, LGU: 265000 },
    support: {
  ...
  },
  {
    ...
    // 최고 요금제 기준 공시지원금 (요금제에 비례해 자동 계산됨)
    official: { SKT: 255000, KT: 265000, LGU: 280000 },
    support: {
  ...
  },
  {
    ...
    // 최고 요금제 기준 공시지원금 (요금제에 비례해 자동 계산됨)
    official: { SKT: 250000, KT: 260000, LGU: 275000 },
    support: {
  ...
  },
  {
    ...
    // 최고 요금제 기준 공시지원금 (요금제에 비례해 자동 계산됨)
    official: { SKT: 300000, KT: 310000, LGU: 330000 },
    support: {
  ...
  },
  {
    ...
    colors: ["블랙", "화이트"],
    // 최고 요금제 기준 공시지원금 (요금제에 비례해 자동 계산됨)
    official: { SKT: 220000, KT: 230000, LGU: 245000 },
    support: {
  ...
  },
  {
    ...
    colors: ["네이비", "실버"],
    // 최고 요금제 기준 공시지원금 (요금제에 비례해 자동 계산됨)
    official: { SKT: 280000, KT: 290000, LGU: 310000 },
    support: {
...
/* =========================================================
   게시판 데이터 — 공지/이벤트, 상품문의(데모)
   ========================================================= */
const NOTICE_POSTS = [
  { date: "2026-06-10", category: "이벤트", title: "갤럭시 S26 시리즈 사전예약 혜택 안내",
    body: "사전예약 기간 내 신청 고객님께 정품 케이스 + 25W 충전기 세트를 드립니다. 개통 완료 후 사은품 신청 링크를 문자로 보내드리며, 신청 기한(개통 후 14일)을 꼭 지켜주세요." },
  { date: "2026-06-08", category: "공지", title: "6월 둘째 주 시세 변동 안내",
    body: "통신사 정책 변경으로 일부 기종의 지원금이 조정되었습니다. 시세표 금액은 매일 오전 갱신되며, 게시 시점 이후 변동될 수 있으니 정확한 금액은 문의 부탁드립니다." },
  { date: "2026-06-05", category: "공지", title: "택배 개통 당일 발송 마감 시간 안내",
    body: "평일/주말 모두 오후 4시 이전 결제 완료 건은 당일 발송됩니다. 4시 이후 건은 다음 영업일 발송되며, 도서산간 지역은 1~2일 추가될 수 있습니다." },
  { date: "2026-06-01", category: "이벤트", title: "후기 작성 이벤트 — 모바일 상품권 증정",
    body: "개통 후 구매후기를 남겨주신 모든 분께 모바일 상품권 5,000원권을 드립니다. 포토 후기는 10,000원권! 자세한 참여 방법은 개통 안내 문자를 확인해 주세요." },
  { date: "2026-05-28", category: "공지", title: "신분증 진위확인 절차 안내 (비대면 개통)",
    body: "비대면 개통 시 정부 신분증 진위확인 서비스를 통해 본인 확인을 진행합니다. 수집된 정보는 개통 용도로만 사용되며 개통 완료 후 관련 법령에 따라 처리됩니다." },
  { date: "2026-05-20", category: "이벤트", title: "가족 결합 추가 혜택 프로모션",
    body: "가족 2회선 이상 동시 개통 시 회선당 추가 사은품을 드립니다. 결합 할인 설계까지 무료로 도와드리니 상담 시 가족 결합 희망을 말씀해 주세요." },
];

/* 상품문의 게시판 데모 데이터 — 실제 운영 시 관리자가 추가/관리 */
const QNA_POSTS = [
  { date: "2026-06-10", product: "갤럭시 S26 울트라", title: "재고 문의드립니다 (티타늄 블루)", author: "김**", secret: false, status: "답변완료",
    q: "티타늄 블루 512GB 재고 있나요? 내일 방문하려고 합니다.", a: "안녕하세요! 네, 티타늄 블루 512GB 재고 보유 중입니다. 방문 전 연락 주시면 바로 수령 가능하게 준비해 두겠습니다." },
  { date: "2026-06-09", product: "아이폰 17 프로맥스", title: "비밀글입니다", author: "이**", secret: true, status: "답변완료" },
  { date: "2026-06-09", product: "갤럭시 Z 플립7", title: "위약금 남았는데 번호이동 가능한가요?", author: "박**", secret: false, status: "답변완료",
    q: "지금 쓰는 폰 할부가 6개월 남았는데 갈아탈 수 있나요?", a: "가능합니다. 남은 할부금/위약금을 조회해서 번호이동과 기기변경 중 더 유리한 쪽으로 안내드릴게요. 문의 남겨주시면 바로 계산해 드립니다." },
  { date: "2026-06-08", product: "아이폰 17", title: "비밀글입니다", author: "최**", secret: true, status: "답변완료" },
  { date: "2026-06-07", product: "갤럭시 A56", title: "부모님 폰으로 개통하려는데 서류가 뭐가 필요한가요?", author: "정**", secret: false, status: "답변완료",
    q: "어머니 명의로 개통하려고 합니다. 같이 방문해야 하나요?", a: "명의자 본인 신분증이 필요하며, 동반 방문이 가장 빠릅니다. 방문이 어려우시면 위임 절차도 안내해 드리니 전화 주세요." },
  { date: "2026-06-06", product: "갤럭시 Z 폴드7", title: "비밀글입니다", author: "한**", secret: true, status: "답변대기" },
];

/* 인터넷 결합 프로모션 — 예시 데이터, 실제 정책으로 교체하세요 */
const INTERNET_PROMO = [
  { carrier: "SKT", speed: "기가 인터넷 + IPTV", monthly: 22000, support: "최대 46만원 지원",
    points: ["휴대폰 결합 시 월 최대 13,200원 추가 할인", "가족 회선 합산 결합 가능", "설치비 면제 프로모션"] },
  { carrier: "KT", speed: "기가 인터넷 + IPTV", monthly: 23000, support: "최대 50만원 지원",
    points: ["총액결합 시 인터넷 월 11,000원 할인", "TV 셋톱 무료 업그레이드", "주말 설치 가능"] },
  { carrier: "LGU", speed: "기가 인터넷 + IPTV", monthly: 22000, support: "최대 48만원 지원",
    points: ["휴대폰 결합 월 최대 13,200원 할인", "가족 무한사랑 결합 지원", "공유기 무상 제공"] },
];
